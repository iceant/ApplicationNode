  ...
  systemJSPrototype.fetch = function (url, options) {
    ...
    .then(function (res) {
      ...
      if (htmlContentType.test(contentType))
        ...
        .then(function (html) {
          return new Response(new Blob([
            'System.register([],function(e){return{execute:function(){e("default",' + JSON.stringify(html) + ')}}})'
          ], {
            type: 'application/javascript'
          }));
        });
      if (cssContentType.test(contentType))
        ...
        .then(function (source) {
          ...
          return new Response(new Blob([
            'System.register([],function(e){return{execute:function(){var s=new CSSStyleSheet();s.replaceSync(' + JSON.stringify(source) + ');document.adoptedStyleSheets=[...document.adoptedStyleSheets, s];e("default",s)}}})'
          ], {
            type: 'application/javascript'
          }));
        });
