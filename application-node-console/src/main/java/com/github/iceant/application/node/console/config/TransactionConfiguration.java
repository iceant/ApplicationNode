...
public class TransactionConfiguration {
     ...
     * TODO 设置service层所在位置
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.github.iceant.application.node.console..*.service..*.*(..))";
    ...
    public TransactionInterceptor txAdvice() {
        ...
        txAttrRequired.setName("RequiredTx");
        ...
        txAttrRequiredReadOnly.setName("ReadonlyTx");
