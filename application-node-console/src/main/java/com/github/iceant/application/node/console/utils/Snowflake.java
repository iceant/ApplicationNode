...
public class Snowflake {
    ...
    // Custom Epoch (January 1, 2022 Midnight UTC = 2022-01-01T00:00:00Z)
    private static final long DEFAULT_CUSTOM_EPOCH = 1640995200000L;
    ...
    public static long makeCustomEpoch(int year, int month, int dayOfMonth, int hour, int minute, int second){
    ...
    public static void main(String[] args) {
        //2015-01-01T00:00:00 1420070400000L
        System.out.println(makeCustomEpoch(2022, 1, 1, 0, 0, 0));
    }
}